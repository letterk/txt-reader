<template>
  <div
    class="fixed inset-0 z-2 flex items-center justify-center bg-black bg-opacity-50"
  >
    <div class="w-400px rounded-lg bg-white p-6 shadow-lg dark:bg-gray-800">
      <h2 class="mb-4 text-xl font-bold dark:text-white">阅读设置</h2>
      ...
      <div class="mb-4">
        ...
        <input
          v-model.number="settingsStore.marginBottom"
          type="number"
          min="0"
          max="1"
          step="0.1"
